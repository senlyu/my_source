...
class GeminiConnect(ModelAPI):
    ...
    def __init__(self, api_key, promot_type):
        self.api_key = api_key
        self.promot_type = promot_type
        if self.promot_type == 'sp':
            self.promot = self.PROMOT + self.PROMOT_FORMAT_SP
        else:
            self.promot = self.PROMOT
